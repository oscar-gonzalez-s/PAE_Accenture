...
if __name__ == '__main__':
    ...
    for image_name in os.scandir(input):
        ...
        img_cropped_list = Detect_Clothes_and_Crop(img, model, list_obj, image_name.name, txt_name)
        ...
        #plain_name = aux2[0]
        cv2.imwrite("/veu4/usuaris26/pae2021/pae/PAE_Accenture-imageRecognition/assets/pipo//outfit_detected/outfit_detected_" + image_name.name, cv2.cvtColor(img_with_boxes, cv2.COLOR_RGB2BGR)*255)
